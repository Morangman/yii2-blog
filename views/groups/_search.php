...
<div class="users-search well well-sm">
    <?php 
    $userSearchParams = Yii::$app->getRequest()->getQueryParam('GroupSearch');
    ...
    <input type="hidden" name="GroupSearch[filter_on]" value="1" />
    <div class="form-group">
    ...
    <?php ActiveForm::end(); ?>
    <a href="#" id="GroupSearchFormToggle">Фильтр</a>
</div>
